...
//===============================================================================================================================================================
	...
	public void createLeadProfession() throws EncryptedDocumentException, IOException, InterruptedException
	{
		...
		Thread.sleep(2000);addMoreDetails_Box.click();
		Thread.sleep(2000);
		Wait.explicitWait(addProfessionIcon, 20, driver);
		addProfessionIcon.click();
		professionName.sendKeys(Excel.Regression_importDataFromExcel("Leads", 2, 11)+" "+utility.UtilityClass.getRandomString(2));
		professionDescription.sendKeys(Excel.Regression_importDataFromExcel("Leads", 2, 12));
	...
	{	
		...
		for (int lead=1; lead<=6; lead++)
		{
			System.out.println("Start to create lead: ("+Excel.Regression_importDataFromExcel("leads", lead, 0)+") under "+Excel.Regression_importDataFromExcel("leads", lead, 3));
			...
			Thread.sleep(1000);	
			driver.findElement(By.xpath("//mat-option//span[contains(text(),'"+Excel.Regression_importDataFromExcel("Leads", lead, 3)+"')]")).click();
			
			Thread.sleep(1000);
			driver.findElement(By.xpath("//span[contains(text(), '"+Excel.Regression_importDataFromExcel("Leads", lead, 4)+"')]")).click();
			submitButton_PopUp.click();
			
			name.sendKeys(Excel.Regression_importDataFromExcel("leads", lead, 0));
			phone.sendKeys(UtilityClass.getRandomIntegers(8));
			
			contactabilityDropdown.click();
			Thread.sleep(1000);
			driver.findElement(By.xpath("//mat-option//span[contains(text(),'"+Excel.Regression_importDataFromExcel("Leads", lead, 5)+"')]")).click();
			
			if (Excel.Regression_importDataFromExcel("Leads", lead, 5).contains("Conversation"))
			{
				this.modeOfInterest=Excel.Regression_importDataFromExcel("Leads", lead, 6);
				if (this.modeOfInterest.contentEquals("Interested"))
				{
					...
					Thread.sleep(1000);
					driver.findElement(By.xpath("//mat-option//span[contains(text(), '"+Excel.Regression_importDataFromExcel("Leads", lead, 7)+"')]")).click();
					...
					Thread.sleep(1000);
					driver.findElement(By.xpath("//mat-option//span[contains(text(), '"+Excel.Regression_importDataFromExcel("Leads", lead, 11)+"')]")).click();
					...
					address.sendKeys(Excel.Regression_importDataFromExcel("Leads", lead, 18));
