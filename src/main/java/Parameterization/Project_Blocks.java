...
//	
	...
	public void createProjectBlocks() throws InterruptedException, EncryptedDocumentException, IOException
	{
		...
		{
			System.out.println("Start to create Project Block: "+Excel.importDataFromExcel("Project Blocks", block, 0));
			Thread.sleep(2000);
			Button_addProjectBlock.click();
			projectName_Dropdown.click();
			Thread.sleep(1000);
			driver.findElement(By.xpath("//mat-option//span[contains(text(), '"+Excel.importDataFromExcel("Project Blocks", block, 1)+"')]")).click();
			
			name_ProjectBlock.sendKeys(Excel.importDataFromExcel("Project Blocks", block, 0)+" "+UtilityClass.getRandomString(2));
			typesOfArea_Dropdown.click();
			Thread.sleep(1000);
			driver.findElement(By.xpath("//mat-option//span[contains(text(), '"+Excel.importDataFromExcel("Project Blocks", block, 2)+"')]")).click();
//			length.sendKeys("100");
